...
local Library = {
    ...
    IsLightTheme = false,
    Scheme = {
        BackgroundColor = Color3.fromRGB(20, 16, 24),
        MainColor = Color3.fromRGB(36, 28, 40),
        AccentColor = Color3.fromRGB(255, 125, 166),
        OutlineColor = Color3.fromRGB(60, 44, 60),
...
function Library:SetWindowTransparency(Value)
    assert(typeof(Value) == "number", "需要数字，实际得到 " .. typeof(Value))
    Value = math.clamp(Value, 0, 100)
    Library.Scheme.WindowTransparency = Value

    for _, Frame in Library.TransparencyFrames do
    ...
    function Funcs:AddDependencyGroupbox()
        ...
        do
            DepGroupboxContainer = New("Frame", {
                ...
                Visible = false,
                Parent = BoxHolder,
            })            DepGroupboxContainer.BackgroundTransparency = Library.Scheme.WindowTransparency / 100
            table.insert(Library.TransparencyFrames, DepGroupboxContainer)
            table.insert(
                Library.Corners,
                New("UICorner", {
                    CornerRadius = UDim.new(0, Library.CornerRadius),
...
function Library:CreateWindow(WindowInfo)
    ...
    do
        ...
        MainFrame = New("TextButton", {
            ...
            Visible = false,
            Parent = ScreenGui,
        })        MainFrame.BackgroundTransparency = Library.Scheme.WindowTransparency / 100
        ...
        BottomBackground = New("Frame", {
            ...
            Parent = MainFrame
        })        BottomBackground.BackgroundTransparency = Library.Scheme.WindowTransparency / 100
        table.insert(Library.TransparencyFrames, BottomBackground)
        Library:MakeLine(MainFrame, {
            AnchorPoint = Vector2.new(0, 1),
        ...
        Tabs = New("ScrollingFrame", {
            ...
            Parent = MainFrame,
        })        Tabs.BackgroundTransparency = Library.Scheme.WindowTransparency / 100
        table.insert(Library.TransparencyFrames, Tabs)
        New("UIListLayout", {
            Parent = Tabs,
        })
        ...
        Container = New("Frame", {
            ...
            Parent = MainFrame,
        })        Container.BackgroundTransparency = Library.Scheme.WindowTransparency / 100
        table.insert(Library.TransparencyFrames, Container)
        New("UIPadding", {
    ...
    --// Window Table \\--
    local Window = {}
    local Fading = false    function Window:SetWindowTransparency(Value)
        ...
        local function AddTabbox(self, Info)
            ...
            do
                TabboxHolder = New("Frame", {
                    ...
                    Size = UDim2.fromScale(1, 0),
                    Parent = BoxHolder,
                })                TabboxHolder.BackgroundTransparency = Library.Scheme.WindowTransparency / 100
                table.insert(Library.TransparencyFrames, TabboxHolder)
                table.insert(
                    Library.Corners,
                    New("UICorner", {
                        CornerRadius = UDim.new(0, WindowInfo.CornerRadius),
        ...
        function Tab:AddGroupbox(Info)
            ...
            do
                GroupboxHolder = New("Frame", {
                    ...
                    Size = UDim2.fromScale(1, 0),
                    Parent = BoxHolder,
                })                GroupboxHolder.BackgroundTransparency = Library.Scheme.WindowTransparency / 100
                table.insert(Library.TransparencyFrames, GroupboxHolder)
                table.insert(
                    Library.Corners,
                    New("UICorner", {
                        CornerRadius = UDim.new(0, WindowInfo.CornerRadius),
    ...
    if Library.IsMobile then
        ...
        Library:AddToRegistry(LockButton, {
            BackgroundColor3 = function()
                return Library.CantDragForced and Library.Scheme.AccentColor or Library.Scheme.BackgroundColor
            end,
            BackgroundTransparency = function()
                return Library.CantDragForced and 0 or 1
            end,
            TextColor3 = function()
                return Library.CantDragForced and Library.Scheme.BackgroundColor or Library.Scheme.FontColor
            end,
        })
        ...
        LockButton.MouseButton1Click:Connect(function()
            ...
            LockButton.Text = Library.CantDragForced and "解锁" or "固定"
            Library:UpdateColorsUsingRegistry()
        end)

        Library:MakeDraggable(MobileBar, MobileBar, true)

        if WindowInfo.MobileButtonsSide == "Right" then
            MobileBar.AnchorPoint = Vector2.new(1, 0)
            MobileBar.Position = UDim2.new(1, -6, 0, 6)
        else
            MobileBar.AnchorPoint = Vector2.new(0, 0)
            MobileBar.Position = UDim2.fromOffset(6, 6)
        end
...
function Library:Unload()
    ...
    table.clear(Library.TransparencyFrames)
